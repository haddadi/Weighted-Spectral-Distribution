...
system("unset LD_LIBRARY_PATH; ./cppgen out_.conf glp_out glp_good_seed")
system("awk 'NR > "N+6"{print $2, $3}' glp_out.brite > edges.txt")
system("cp edges.txt glp_edges.txt")
system("cp edges.txt glp_finished.txt")
